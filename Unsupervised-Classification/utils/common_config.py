...
add_path(os.path.abspath('/home/chominhi/work/init-pools-dal-main/master_Unsupervised-Classidication'))
...
from data.augment import Augment, Cutout  # 자꾸 master 파일을 못 읽어서 그냥 Unsupervised-Classidiation에 복붙함   

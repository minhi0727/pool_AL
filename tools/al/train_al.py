...
def main(cfg):
    ...
    cfg.OUT_DIR = os.path.join(os.path.abspath('/home/chominhi/work/init-pools-dal-main'), cfg.OUT_DIR)
...
if __name__ == "__main__":
    ...
    if cfg.SWEEP:
        ...
        os.environ['WANDB_API_KEY'] = "8eeb01f18916436852ca7e69ff418a28200c6089"
        wandb.login()
